function createFlower() {
    ...
    for (let j = 0; j < maxFlowers; j++) {
        ...
        //  posiciones aleatorias y verificar que no se superpongan con las existentes
        while (!positionValid) {
        ...
        // nueva posición a la lista de posiciones existentes
